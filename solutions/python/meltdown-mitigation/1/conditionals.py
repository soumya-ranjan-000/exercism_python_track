...
def fail_safe(temperature, neutrons_produced_per_second, threshold):
    ...
    if (int(temperature * neutrons_produced_per_second)) < int(0.90 * threshold):
        return 'LOW'
    elif((int(temperature * neutrons_produced_per_second) > (int(threshold)-int(0.10 * threshold))) and (int(temperature * neutrons_produced_per_second)) < (int(threshold)+int(0.10 * threshold))):
        return 'NORMAL'
    else:
        return 'DANGER'
